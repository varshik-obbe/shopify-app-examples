  ...
  */
  ...
  const {
    ...
    */
    ...
    url: "https://api.theprintribe.com/api/customerInventory/getProducts/61e7a8af6b91a9d48b531e9c",
  });
  ...
  const qrCodesMarkup = QRCodes?.products.length ? (
    <QRCodeIndex QRCodes={QRCodes.products} loading={isRefetching} />
  ) : null;

  /* Use Polaris Card and EmptyState components to define the contents of the empty state */
  const emptyStateMarkup =
    !isLoading && !QRCodes?.products.length ? (
      <Card sectioned>
        <EmptyState
          heading="Please add your design on a product"
          /* This button will take the user to a Create a QR code page */
        >
          <p>
            you can add your design on a product and it will be displayed here.
          </p>
        </EmptyState>
      </Card>
    ) : null;
